...
<div class="container">
	<div class="legal-text">
		<h3> 1. Общие положения </h3>
		 Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. №152-ФЗ «О персональных данных» (далее - Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые&nbsp;ИП Винокуровым Сергеем Владимировичем&nbsp;(далее – Оператор). <br>
		 1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну. <br>
		 1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта&nbsp;<a href="https://liderws.r/">https://liderws.ru/</a>. <br>
		<h3>2. Основные понятия, используемые в Политике</h3>
		 ...
		 2.3. Веб-сайт – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a href="https://liderws.r/">https://liderws.ru/</a>. <br>
		 ...
		 2.8. Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a href="https://liderws.r/">https://liderws.ru/</a>. <br>
		 ...
		 2.10. Пользователь – любой посетитель веб-сайта <a href="https://liderws.r/">https://liderws.ru/</a>. <br>
		...
		<h3> 5. Оператор может обрабатывать следующие персональные данные Пользователя </h3>
		 ...
		 5.4.&nbsp;Почтовый адрес. <br>
		 5.5. Также на сайте происходит сбор и обработка обезличенных данных о посетителях (в т.ч. файлов «cookie») с помощью сервисов интернет-статистики (Яндекс Метрика). <br>
		...
		<h3> 7. Цели обработки персональных данных </h3>
		 ...
		 –&nbsp;предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте <a href="https://liderws.r/">https://liderws.ru/</a>; <br>
		 –&nbsp;доставка заказа Пользователю и информирование о статусе заказа. <br>
		 7.2. Также Оператор имеет право направлять Пользователю уведомления о новых продуктах и услугах, специальных предложениях и различных событиях. Пользователь всегда может отказаться от получения информационных сообщений, направив Оператору письмо на адрес электронной почты&nbsp;<a href="mailto:lider-16@bk.ru">lider-16@bk.ru</a>&nbsp;с пометкой «Отказ от уведомлений о новых продуктах и услугах и специальных предложениях». <br>
		...
		<h3> 8. Правовые основания обработки персональных данных </h3>
		 ...
		 8.2. Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте <a href="https://liderws.r/">https://liderws.ru/</a> или направленные Оператору посредством электронной почты. Заполняя соответствующие формы и/или отправляя свои персональные данные Оператору, Пользователь выражает свое согласие с данной Политикой. <br>
		...
		<h3> 10. Порядок сбора, хранения, передачи и других видов обработки персональных данных </h3>
		 ...
		 10.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора&nbsp;<a href="mailto:lider-16@bk.ru">lider-16@bk.ru</a>&nbsp;с пометкой «Актуализация персональных данных». <br>
		 ...
		 Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора&nbsp;<a href="mailto:lider-16@bk.ru">lider-16@bk.ru</a>&nbsp;с пометкой «Отзыв согласия на обработку персональных данных». <br>
		...
		<h3> 14. Заключительные положения </h3>
		 14.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <a href="mailto:lider-16@bk.ru">lider-16@bk.ru</a>. <br>
		 ...
		 14.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу&nbsp;<a href="https://liderws.ru/soglasie/">https://liderws.ru/soglasie/</a>. <br>
		<h3> 15. Использование файлов cookie </h3>
		 15.1. Сайт использует файлы cookie — небольшие текстовые файлы, которые сохраняются в браузере Пользователя и позволяют сайту запоминать действия и настройки Пользователя на протяжении определённого времени, чтобы Пользователю не нужно было вводить их повторно при каждом посещении сайта или переходе с одной страницы на другую. <br>
		 15.2. Используемые на сайте файлы cookie по сроку хранения делятся на сессионные (удаляются автоматически при закрытии браузера) и постоянные (хранятся до истечения установленного срока или до удаления Пользователем), а по назначению — на: <br>
		 — технические (необходимые) — обеспечивают работу основных функций сайта (авторизация, корзина, оформление заказа, сохранение настроек фильтров); <br>
		 — аналитические и статистические — используются для сбора обезличенных сведений о посещаемости сайта и поведении Пользователей, в том числе с помощью сервисов интернет-статистики (Яндекс.Метрика и аналогичные); <br>
		 — функциональные — запоминают выбор Пользователя (регион, ранее просмотренные товары, содержимое корзины) для повышения удобства использования сайта. <br>
		 15.3. Оператор может использовать файлы cookie, устанавливаемые третьими лицами (сервисами веб-аналитики), которые действуют в соответствии с собственными политиками конфиденциальности, не контролируемыми Оператором. <br>
		 15.4. Продолжая использовать сайт, Пользователь выражает согласие на обработку файлов cookie в вышеуказанных целях. <br>
		 15.5. Пользователь может самостоятельно управлять файлами cookie и отключить их сохранение в настройках своего браузера. Отключение cookie может привести к неполной или некорректной работе отдельных функций сайта, в том числе корзины и оформления заказа. <br>
		 15.6. Дополнительную информацию о том, какие файлы cookie используются на сайте и как ими управлять, можно получить, обратившись к Оператору по адресу электронной почты <a href="mailto:lider-16@bk.ru">lider-16@bk.ru</a>. <br>
 <br>
	</div>
 <br>
</div>
