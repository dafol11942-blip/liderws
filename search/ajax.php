...
// длинных списков. Было снижено с 80 до 30: при 80 парах Phase2 регулярно рассылал
// 500-600+ запросов к 9 поставщикам и стабильно упиралось в дедлайн ~24с на каждый
// поиск — на виртуальном хостинге с ограниченными ресурсами это приводило к
// перегрузке и убийству PHP-FPM пула хостом. Поднято до 50 для замера реального
// времени докрутки при увеличенном лимите — если хостинг снова начнёт падать
// или докрутка будет стабильно не укладываться в клиентский таймаут (90с,
// см. fetchWithTimeout в search/index.php), нужно вернуть 30 или найти
// компромисс между ними.
const MAX_ANALOG_PAIRS = 50;
