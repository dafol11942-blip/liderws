...
if ( document.querySelector("#select-Vin") ) {

  const selectVin = new CustomSelect('#select-Vin');

}

if ( document.querySelector("#select-footer-1") ) {

  const select_footer1 = new CustomSelect('#select-footer-1');
  const select_footer2 = new CustomSelect('#select-footer-2');
