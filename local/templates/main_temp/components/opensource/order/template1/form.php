...
<form action="" method="post" name="os-order-form" id="os-order-form">
 ...
 // debug($arResult);
  ...
  <!--   <input type="text" name="properties[1]" placeholder="Почта">

    <input type="text" name="properties[2]" value="" placeholder="Имя"> -->
                ...
                <td>
                    ...
                    switch ($arProp['TYPE']):
                        case 'LOCATION':
                            ?>
                            <div class="location">
                                <select id="location-search-select" class="location-search" name="<?= $arProp['FORM_NAME'] ?>"
                                ...
                                <input type="text" id="location-search" value="">
