...
?>
 ...
 <section class="main-banner banner-tech">
        <div class="container">
...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
        ...
        <div id="<?=$this->GetEditAreaId($arItem['ID']);?>" class="main-banner__item swiper-slide">
            ...
            <!-- <a href="" class="btn bg-red">Подробнее</a> -->
            <div class="main-banner__btns">
                            <a href="#" data-modal-name='Технический осмотр' class="modal-tech-osmotr-btn btn bg-red">Записаться</a>
                            <a href="<?echo $arItem['PROPERTIES']['LINK']['VALUE']?>" class="btn bg-white">Показать на карте</a>
                        </div>
        </div>
