...
<section class="main__order">
        <div class="container">
            <div class="main__order-inner">
                <div class="ordered__top">
                    <div>Ваш заказ</div>
                    <div class="count-main"><? echo $arResult['allSum'] ?> ₽</div>
                </div>
                <div class="ordered__inner" style="justify-content: space-between;">
                    ...
                    <!-- <div class="oredered__block">
                        ...
                        <a href="#" class="dashed">Изменить пункт заказа товара</a>
                    </div> -->
                    ...
                    <div class="ordered__block ordered__block-btn">
                        ...
                        <a  class='btn bg-red' href="<? echo $url = ((!empty($_SERVER['HTTPS'])) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST']; ?>/personal/order/">Оформить заказ</a>
                    </div>
                </div>
            </div>
        </div>
 ...
 <section class="product catalog_bmw_list cart__catalog">
        <div class="container df">
            <div class="product__inner_list product__inner">

                <div class="analog__item-main ac  product__desc analog__item not__after">
                    <div class="analog_num">№</div>
                    <div class="anolog__kod ">Фото</div>
                    <div class="analog__name">Номер (код)</div>
                    <div class="analog_date">Склад</div>
                    <div class="analog__price">Цена</div>
                    <div class="analog__svg">В корзину</div>
                </div>
                ...
                <? foreach($arResult['ITEMS']['AnDelCanBuy'] as $key => $item):?>
	                ...
	                <div class="analog__item product__item">
	                    <div class="analog_num"><?echo $i = $key+1;?></div>
	                    <div class="cart__img">
        					...
        					<img style="width: 110px;height: 110px;" src="<?= $bgImage?>" alt="">
	                        <!-- <img style="width: 110px;height: 110px;" src="<?echo $item['PREVIEW_PICTURE_SRC']?>" alt=""> -->
	                    </div>
	                    <a href="/catalog/<? echo $item['DETAIL_PAGE_URL']?>" class="anolog__kod blue cart__kod"><?echo $item['NAME'];?></a>
	                    <div class="analog__name cart__sklad">
	                    	...
	                    	<?
								...
								{
									$store_name = $arStoreProduct['STORE_TITLE'];
	                    ...
	                    <div class="product__price ">
	                        <div><?echo $item['PRICE_FORMATED']?></div>
	                    ...
	                    <div class="product__sum"> 
	                        <div class="product__count">
	                            ...
	                            <input class="item__number" value="<?echo $item['QUANTITY']?>" type="number" id="<? echo $item['PRODUCT_ID']?>">
	                        ...
	                        <div class="product__status hidden">
	                            <div class="product__status-have">В наличии</div>
	                        </div>
	                    </div>
	                    <a href="#" class="remove__cart" data-id="<? echo $item['PRODUCT_ID']?>">
	                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
	                            <path d="M15.2136 1.07107L1.07151 15.2132M1.07151 1.07107L15.2136 15.2132" stroke="#C4C4C4" stroke-width="2" stroke-linecap="round"/>
	                        </svg>                            
	                    </a>
	                    <div style="display: none;" class="product__hover">
	                        <div class="analog__item-hover">
	                            <div class="product__hover-item">
	                                <div>Заказ</div>
	                                <div>Сегодня при заказе до 15:00</div>
	                            </div>
	                            <div class="product__hover-item">
	                                <div>Гарантия</div>
	                                <div>Есть</div>
