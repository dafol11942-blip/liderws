...
foreach($arResult["ITEMS"] as $key=>$arItem)
{
 ...
 -->
						<div class="bx_ui_slider_pricebar_VD" style="left: 0;right: 0;background: #668BEA;" id="colorUnavailableActive_<?=$key?>"></div>
						<div class="bx_ui_slider_pricebar_VN" style="left: 0;right: 0;background: #E2E2E2;" id="colorAvailableInactive_<?=$key?>"></div>
						<div class="bx_ui_slider_pricebar_V"  style="left: 0;right: 0;background: #668BEA;" id="colorAvailableActive_<?=$key?>"></div>
