...
<!-- <?//=$arResult["FORM_ACTION"]?> -->
		<form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="/bitrix/tools/sender_sub_confirm.php?" class="mailing">
	        ...
	        <div class="mailing__right mailing__right-wrapper">

	        	<div class="mailing__right-block">
		            <!-- <input placeholder="Электронная почта" type="text" mailing__input> -->

		            <input class="bx-form-control mailing__input" type="email" name="SENDER_SUBSCRIBE_EMAIL" required value="" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="Электронная почта">

		            <button class="btn bg-red">Подписаться</button>
		        </div>

            	<label class="mailing__right-checkbox">
					<input type="checkbox" name="agree" required>
					<p>
						Нажимая кнопку Отправить, Вы даете согласие на обработку <a href="/soglasie/" target="_blank">персональных данных</a>
					</p>
				</label>
...
?>
	...
	<form  id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>" class="mailing">
        ...
        <div class="mailing__right">
            ...
            <input class="bx-form-control mailing__input" type="email" required name="SENDER_SUBSCRIBE_EMAIL" value="" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="Электронная почта">
