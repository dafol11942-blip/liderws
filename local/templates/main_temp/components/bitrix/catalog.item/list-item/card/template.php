...
<!-- <div class="product__item"> -->
    ...
    <div class="product__right">
        ...
        <!-- <a href="#" class="product__title">Масло моторное Ford Formula F 5W-30, синтетическое, 5L</a> -->

        <div class="product__list-item product__list-item-kod"><?echo $item['PROPERTIES']['CML2_ARTICLE']['VALUE']; ?></div>
        <div class="product__list-item"><?= $item['PRODUCT']['QUANTITY'] ?></div>
        <div class="product__list-item product__list-item-mob">
        	<div><?= $item['PRODUCT']['QUANTITY'] ?> шт </div>
        	<div>
        ...
        <!-- 	<div>
	            ...
	            <a href="#" class="product-item-btn add_to_basket__ajax" id="28525">
		        ...
		        <? endif;?>
		         ...
		         <? if(!empty($actualItem['PRODUCT']['QUANTITY_IN_CART'])):?>
		         	<a class="in_cart in_cart-list" href="/cart/">в Корзину</a>
		         <? else:?>
		         	<a class="in_cart in_cart-list" style="display: none" href="/cart/">в Корзину</a>
		         <? endif;?>
...
<!-- 
		    <div style="position: relative;z-index: 100;" class="product-item-button-container" id="<?//=$itemIds['BASKET_ACTIONS']?>">
				 ...
				 <div class="product__count product__count-catalog__list" style="display: none;">
	                ...
	                <button class="item__plus add_to_basket" id="<?//=$item['ID']?>">
	                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
	                        <path d="M6 1L6 11M1 6H11" stroke="white" stroke-width="2" stroke-linecap="round"></path>
	                    </svg> 
	                </button>
