...
if (isset($arResult['ITEM']))
{
	...
	while ($item_quantitty = $dbRes->fetch())
	{
	    // debug($item_quantitty);
	    if($item_quantitty['PRODUCT_ID'] == $item['ID']){

			$item['PRODUCT']['QUANTITY_IN_CART'] = intval($item_quantitty['QUANTITY']);
	...
	<div data-id="<?= $arResult['ITEM']['ID']?>" class="product__item with_filter"
		id="<?=$areaId?>">
		<?
