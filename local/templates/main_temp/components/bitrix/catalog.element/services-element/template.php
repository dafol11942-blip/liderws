...
<section class="detail-page-services bx-<?//=$arParams['TEMPLATE_THEME']?>"  id="<?//=$itemIds['ID']?>">
        <div class="container df ac ">
            <a class="product__back" href="<?= $arParams['back_url'] ?>">
                <div class="df ac">
...
<div class="detail-page-services container df fw">
    <div class="right__inner">
        <div class="fz14"><?=$arResult["DISPLAY_ACTIVE_FROM"]?></div>
        <div class="image__container-full w580">
			...
			/>
            <!-- <img src="images/news__statie-product.png" alt=""> -->
            <div class="lypa__svg">
		...
		<div class="right__main-dvs">
			<div class="contact__item">
				...
				<div class="two__item">
					<div>Адрес</div>
					<div>РТ, Елабуга, пр-т Нефтяников, д.4в ст.1</div>
				</div>
				<div class="two__item">
					<div></div>
				...
				<a href="#" data-modal-title='<?=$arResult["NAME"]?>' class="modal-services-detail-btn btn bg-red">Записаться</a>
			</div>
		</div>
