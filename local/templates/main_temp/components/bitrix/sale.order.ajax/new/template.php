...
else
{
	...
	// $arResult['ORDER_PROP']['RELATED'][0]['VALUE_FORMATED'] = 'lol';
	// $arResult['ORDER_DATA']['USER_VALS'][8] = 'LOL';
	// $arResult['ORDER_PROP']['ORDER_PROP']['properties'][4]['VALUE'][0] = "lol";

	 // debug($_SESSION);
	// debug($arResult['ORDER_PROP']['RELATED'][0]['VALUE_FORMATED']);

	?>


	<form style="margin-top: 1rem;" action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		<?
		...
		<div id="bx-soa-order" class="row  bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			<!--	MAIN BLOCK	-->
			<div class="col-sm-9 bx-soa container">
				...
				<div class="main-order-box cart__inner">

					<div class="BUYER-PROPS-BLOCK cart__left">
						<!--	BUYER PROPS BLOCK	-->
						<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
							<!-- <div id="bx-soa-properties-personal">
								<div>	</div>
								<div class="bx-soa-section-content1 container-fluid1">	</div>
							</div> -->
							<!-- <div class="bx-soa-section-title-container">
								<h2 class="bx-soa-section-title col-sm-9">
							...
							<div class="cart__tit">Личные данные</div>
							<div class="bx-soa-section-content container-fluid"></div>
					...
					<div class="main-order-right cart__right">


						<? if ($arParams['BASKET_POSITION'] === 'after'): ?>
							<!--	BASKET ITEMS BLOCK	-->
							<div style="display:none !important;" id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active basket-items-block">
								<!-- <div class="bx-soa-section-title-container">
									<h2 class="bx-soa-section-title col-sm-9">
...
<!--								<div class="bx-soa-section-content container-fluid"></div>-->
						...
						<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
							<!--	PAY SYSTEMS BLOCK p2d	-->
							<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active cart__oplata">
								<!-- <div class="bx-soa-section-title-container">
									<h2 class="bx-soa-section-title col-sm-9">
								...
								<div class="cart__tit">Способы оплаты</div>
								<div class="bx-soa-section-content container-fluid"></div>
							</div>
							...
							<!--	REGION BLOCK 1	-->
							<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active cart__delivery ">
								<!-- <div class="bx-soa-section-title-container">
									<h2 class="bx-soa-section-title col-sm-9">
						...
						<input class="checkbox_iphone" id="regist__sogl" checked="checked" value="1" name="UF_SOGLASIE_FORM" type="checkbox">
...
<!-- END MAIN BLOCK -->
		...
		<!-- 	<div class="cart-sum-delivery"></div>
			<div class="cart-total-sum"></div>

			<div class="cart-sum"></div>
			<div class="cart-sum-delivery"></div>
			<div class="cart-total-sum-2"></div> --> 

				<section class="main__order mt20 ">
			        <div id="bx-soa-total" class="container">

			        	<div class="bx-soa-cart-total-ghost "></div>
						<div class="bx-soa-cart-total hidden"></div>

			        	<!-- //<div id="bx-soa-total" class="col-sm-3 bx-soa-sidebar"> -->
			            <div class="main__order-inner">
			                <div class="ordered__top">
			                    <div>Ваш заказ</div>
			                    <div class="cart-total-sum"></div>
			                </div>
			                <div class="ordered__inner" style="justify-content: space-between;">

			                   <!--  <div class="oredered__block">
			                        <div class="two__item">
			                            <div>Пункт</div>
			                            <div class="w100">Самовывоз в г. Набережные Челны ТК СДЭК</div>
			                        </div>
			                        <a href="#" class="dashed">Изменить пункт выдачи заказов</a>
			                    </div> -->
			                    ...
			                    <!-- <div class="ordered__block ordered__block-btn">
			                        <a class="btn bg-red" href="#">Оформить заказ</a>
			                    </div> -->
			                </div>
			            </div>
			        </div>
...
$(document).ready(function(){
	...
	// 	$("input[name='ORDER_PROP_26']").prop('checked', true);


	// }, 5000);


   	// $("input[name='ORDER_PROP_8']").val("<?echo $arUser['UF_MAIN_ADDRESS'];?>");
   	// $("input[name='ORDER_PROP_24']").val("<?echo $arUser['UF_MAIN_ADDRESS'];?>");
	...
	<script>
		...
		BX.Sale.OrderAjaxComponent.init({
			...
			data_addres_main:"<?echo $arUser['UF_MAIN_ADDRESS'];?>",
			data_city_main:"<?echo $_SESSION['location_code'] ?>",
