				...
				<div class="main-order-box">
					...
					<div class="main-order-right">
						...
						<? if ($arParams['BASKET_POSITION'] === 'after'): ?>
							<!--	BASKET ITEMS BLOCK	-->
							<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active basket-items-block">
								<div class="bx-soa-section-title-container">
									<h2 class="bx-soa-section-title col-sm-9">
			...
			<!--	END SIDEBAR BLOCK	-->
				...
				<div class="end-order-block">
					...
					<div id="bx-soa-total" class="col-sm-3 bx-soa-sidebar">
						<div class="bx-soa-cart-total-ghost Lol"></div>
