...
<div class="bx-authform">
	...
	<form name="bform" class="1" method="post" target="_top" action="<?= POST_FORM_ACTION_URI;?>">
		...
		<div class="bx-authform-formgroup-container">
			<input type="submit" class="btn btn-primary bg-blue" name="<?= $arResult['FIELDS']['action'];?>" value="<?= Loc::getMessage('MAIN_AUTH_PWD_FIELD_SUBMIT');?>" />
		</div>
