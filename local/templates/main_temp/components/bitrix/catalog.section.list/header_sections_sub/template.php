	...
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'TEXT':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				$count = count($page_url) - 2;

				// debug($page_url);

				// debug($count);

				// debug($page_url[$count]);

				$this_page = explode('/', $arSection['SECTION_PAGE_URL']);

				$count1 = count($this_page) - 2;
			...
			<? if($page_url[$count]  == $this_page[$count1]):?>


	            <!-- <li class="active"  id="<? echo $this->GetEditAreaId($arSection['ID']); ?>"> <?// active?> -->
	                <a class="similar-categories__active" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" href="<? echo $arSection['SECTION_PAGE_URL']; ?>"><? echo $arSection['NAME']; ?></a>
	            <!-- </li> -->

            <? else: ?>

	          
	                <a id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" href="<? echo $arSection['SECTION_PAGE_URL']; ?>"><? echo $arSection['NAME']; ?></a>
