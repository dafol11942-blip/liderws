...
<svg xmlns="http://www.w3.org/2000/svg" style="display:none" aria-hidden="true">
    ...
    <symbol id="icon-heart" viewBox="0 0 24 24">
        <path d="M12 21s-7.5-4.6-10-9.5C0.3 7.9 2.1 4 6 4c2.1 0 3.6 1.1 6 3.7C14.4 5.1 15.9 4 18 4c3.9 0 5.7 3.9 4 7.5-2.5 4.9-10 9.5-10 9.5z"/>
    </symbol>
    ...
    <symbol id="icon-cart" viewBox="0 0 24 24">
        ...
        <path d="M2.5 3h2l2.68 12.39a2 2 0 0 0 2 1.61h8.64a2 2 0 0 0 2-1.61L22 8H6.2"/>
    </symbol>
